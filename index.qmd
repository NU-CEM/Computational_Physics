...
The source code for this website can be found in the [course Github repository](https://github.com/nu-cem/Computational_Physics).
If you spot any mistakes or would like to make a suggestions for improving the course please [raise an issue on Github](https://github.com/nu-cem/Computational_Physics/issues).
