...
The website is powered by [Github](https://github.com/NU-CEM/Computational_Physics/), [Quarto](https://quarto.org/) and [Jupyter Notebook](https://jupyter.org). Text is formatted with Markdown and equations are formatted with LaTeX.
